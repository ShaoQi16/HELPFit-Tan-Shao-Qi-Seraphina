...
<body>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" <?php echo('href="homepageTrainer.php?username='.$username.'"')?>>
        <img id="logo" src="fitnessLogo.png"></a>
    </div>
    ...
    <ul class="nav navbar-nav navbar-right">
        <li class="dropdown"><a href="#"class="dropdown-toggle" data-toggle="dropdown">
          ...
          <ul class="dropdown-menu">
            <br>
            <li>
              <?php echo('<a href="userdetailstrainer.php?username='.$username.'">')?><span class="fa fa-pencil">
              </span> &nbsp;Update Details</a></li>
            <li class="divider"></li>
...
<div class="row" id="box-search">
    <div class="text-center text-white">
        ...
        <div id="caption-desktop"class="caption">
            ...
            onclick='location.<?php echo('href="recordNewTrainingSession.php?username='
            .$username.'"')?>'>
            Start now! </button></h3>
          </div>
        </div>
          <div id="caption-mobile" class="caption">
              <h1 id="welcomeMessage">Welcome, <?php echo $_SESSION["username"]; ?>
              </h1><br>
</div></div></div>
...
<div id="area" class="row">
  ...
  <div class="col-sm-6 col-xs-12 text-center">
    <a <?php echo('href="recordNewTrainingSession.php?username='.$username.'"')?>><img id="hoverbtn" class="img-circle" src="fitnesspic8.jpg" alt="" width="140" height="140"></a>
    <h2 id="headings">Sessions</h2>
    <p id="grey">Allows users to register or record a new training session.</p>
  </div>
  <div class="col-sm-5 col-xs-12 text-center">
    <a <?php echo('href="viewtrainingrecordstrainer.php?username='.$username.'"')?>><img id="hoverbtn" class="img-circle" src="fitnesspic7.jpg" alt="" width="140" height="140"></a>
