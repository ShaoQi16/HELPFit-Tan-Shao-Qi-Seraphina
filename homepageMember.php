...
<div class="row" id="box-search">
    <div class="text-center text-white">
        ...
        <div id="caption-desktop"class="caption">
            <h1 id="welcomeMessage">Welcome, <?php echo $username; ?></h1>
            <div class="hidden-xs">
            <h3 id="hpHeading">Begin your journey.</h3><br>
            <button id="hpbutton" type="button" class="btn-lg"
            onclick="location.href='<?php echo('registerForTrainingSession.php?username='.$username)?>'"> Start now! </button></h3>
          </div>
        </div>
          <div id="caption-mobile" class="caption">
              <h1 id="welcomeMessage">Welcome, <?php echo $username; ?></h1><br>
          </div>
    </div>
</div>
...
<div id="area" class="row">
  ...
  <div class="col-sm-6 col-xs-12 text-center">
    <a <?php echo('href="registerForTrainingSession.php?username='.$username.'"')?>><img id="hoverbtn" class="img-circle" src="fitnesspic8.jpg" alt="" width="140" height="140"></a>
    <h2 id="headings">Sessions</h2>
    <p id="grey">Allows users to register or record a new training session.</p>
  </div>
  <div class="col-sm-5 col-xs-12 text-center">
    <a <?php echo('href="viewtrainingrecordsmember.php?username='.$username.'"')?>><img id="hoverbtn" class="img-circle" src="fitnesspic7.jpg" alt="" width="140" height="140"></a>
