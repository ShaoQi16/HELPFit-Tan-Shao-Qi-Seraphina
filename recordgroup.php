  ...
  <div class="container-fluid">
    ...
    <div class="col-xs-offset-1 col-xs-10 col-sm-offset-3 col-sm-8">
      <div id="testing" class="col-xs-12  col-sm-9" style="text-align:center">
          <h2 id="pagetitle"><b>Record New Training Session </b></h2>
          <br>
          <form name="trainingsessionform" action="TSGserver.php" method="post">
          <div class="row">
        ...
        <div class="form-group">
          <div class="input-group">
            <input class="form-control" id="maxInput" name="maxParticipants" placeholder="10" type="text" required/>
          </div>
        </div>
      </div>
